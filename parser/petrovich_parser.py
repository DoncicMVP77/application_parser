...
class PetrovichParser(BaseParser):
    ...
    def __init__(self):
        ...
        self.headers = {'authority': 'api.petrovich.ru',
                ...
                'cookie': 'u__geoCityGuid=b835705e-037e-11e4-9b63-00259038e9f2; u__geoUserChoose=1; '
                          'SIK=fQAAAKYhHituULgSbicIAA; SIV=1; '
                          'C_2orUj4RbWJX-j2qd_tb1pLl3dQo=AAAAAAAACEAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA8D8AAMDNDdbpQaaI'
                          '-PDrj_mr1rceKGwUuUI; _gcl_au=1.1.950704639.1671053130; '
                          'tmr_lvid=c1484313d2acd33489116f19f69906d0; tmr_lvidTS=1671053131274; '
                          '_ym_uid=1671053131251279816; _ym_d=1671053131; '
                          'UIN=fQAAANTnQkHYek8WOeKdXFnIYEdHgoQXcVC4Et5JBwA; '
                          'ssaid=d7c99630-7bf5-11ed-aadc-4bf072c36bf8; rrpvid=267247304460759; '
                          'rcuid=639a3f4f514016510e303044; adrcid=A5MELJfJJOupWj7Ed12WA2w; dd_user.isReturning=true; '
                          'aplaut_distinct_id=g5sySwa7vGYM; '
                          'FPID=FPID1.2.PfCLw4RysDx667ur652PCTYaDnrReTXNLTDkHK2lzx0^%^3D.1671053131; '
                          'popmechanic_sbjs_migrations=popmechanic_1418474375998^%^3D1^%^7C^%^7C^%^7C1471519752600'
                          '^%^3D1^%^7C^%^7C^%^7C1471519752605^%^3D1; _gid=GA1.2.1527413864.1671442360; SNK=121; '
                          'u__typeDevice=desktop; _ym_isad=2; '
                          'FPLC=lfT0K3lNPAiWZnyJlyCS4W6XvGKmWK484TGFWOKtDtE3lHLx^%^2Fm17AAI7XMZbsGBV'
                          '^%^2Fl7hdkvu9TvQ8OngLRM6KwEX^%^2BaG3u^%^2FlCOI^%^2F9pKquYU2kRnTOieFH4UGda^%^2FT80A^%^3D'
                          '^%^3D; _ym_visorc=b; dd__persistedKeys=^['
                          '^%^22custom.lastViewedProductImages^%^22^%^2C^%^22user.isReturning^%^22^%^2C^%^22custom'
                          '.lt13^%^22^%^2C^%^22custom.ts14^%^22^%^2C^%^22custom.ts12^%^22^%^2C^%^22custom.lt11^%^22'
                          '^%^2C^%^22custom.productsViewed^%^22^]; rrviewed=603404; '
                          'dd_custom.lastViewedProductImages=^[^%^22^%^22^%^2C^%^223520^%^22^%^2C^%^22^%^22^]; '
                          'dd_custom.productsViewed=3; dd_custom.ts12=^{'
                          '^%^22ttl^%^22:2592000^%^2C^%^22granularity^%^22:86400^%^2C^%^22data^%^22:^{'
                          '^%^221671148800^%^22:6^%^2C^%^221671408000^%^22:11^%^2C^%^221671494400^%^22:3^}^}; '
                          'dd_custom.lt11=2022-12-20T10:24:21.796Z; rrlevt=1671531865183; '
                          '_ga=GA1.2.1499298080.1671053131; _dc_gtm_UA-23479690-1=1; '
                          'qrator_msid=1671530183.342.NdAyVGFujXMSY3y1-6n5q5ip51qrne20r9cn24o4krqu8173i; _gat_ddl=1; '
                          'dd_custom.lt13=2022-12-20T10:35:58.593Z; dd_custom.ts14=^{'
                          '^%^22ttl^%^22:2592000^%^2C^%^22granularity^%^22:86400^%^2C^%^22data^%^22:^{'
                          '^%^221671062400^%^22:1^%^2C^%^221671148800^%^22:10^%^2C^%^221671408000^%^22:7^%^2C'
                          '^%^221671494400^%^22:15^}^}; __tld__=null; _dc_gtm_UA-23479690-19=1; '
                          'dd__lastEventTimestamp=1671532558637; '
                          'digi_uc=; mindboxDeviceUUID=f7c3232c-3fd8-413b-aaf2-929c07d58670; directCrm-session=^%^7B^%^22deviceGuid^%^22^%^3A^%^22f7c3232c-3fd8-413b-aaf2-929c07d58670^%^22^%^7D; _gat_popmechanicManualTracker=1; _ga_XW7S332S1N=GS1.1.1671531492.16.1.1671532573.43.0.0" ^',
    ...
    def get_dict_with_city_shop(self) -> dict:
        with open('static/petrovich/petrovich_city.json', "r", encoding="utf-8") as outfile:
